...
autoRegressiveModelResults = pd.read_csv("Results/covidAutoregressiveModels.csv")
...
results_file_path = "Results/covidAutoRegressiveMethodsf1.csv"
...
for model in models:
    ...
    y_true = test_df["speculative"]
    y_pred = autoRegressiveModelResults[model]

    test_f1_score = f1_score(y_true, y_pred)

    results = {"method": model, "f1_score": test_f1_score}
